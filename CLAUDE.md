...
| `alert-checks.js` | `*/15 * * * *` | pre-kickoff push, odds alerts, results for followed teams/players, spend-limit buddy alerts, BetMates Plus trial-ending reminder, paid-group renewal reminder (merged - see file header) |
