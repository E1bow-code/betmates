...
| `alert-checks.js` | `*/15 * * * *` | pre-kickoff push, odds alerts, results for followed teams/players, spend-limit buddy alerts, BetMates Plus trial-ending reminder (merged - see file header) |
